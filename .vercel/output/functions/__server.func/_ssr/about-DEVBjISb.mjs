...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 grid md:grid-cols-2 gap-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(InfoCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "size-5" }), title: "Registrations", lines: ["GST: 33ABCFV1505G1ZM", "MSME: UDYAM-TN-12-0182473", "Business PAN: ABCFV1505G"] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-16 grid md:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Value, { n: "01", t: "Authenticity", b: "Every batch is verified against traditional grading standards before it leaves our warehouse." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Value, { n: "02", t: "Fair sourcing", b: "We pay growers fairly and build long-term relationships with farming families." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Value, { n: "03", t: "Consistency", b: "Repeat buyers tell us our consistency — in quality, weight and timing — is what keeps them coming back." })
    ] })
  ] });
}
function InfoCard({
