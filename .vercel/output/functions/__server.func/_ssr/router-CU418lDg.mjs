...
const appCss = "/assets/styles-CG-ypUgr.css";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-16 items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-display text-lg font-semibold leading-none", children: "Vel Trading Agency" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-[0.3em] text-muted-foreground mt-1", children: "Madurai · India" })
          ] })
        ] }),
...
const $$splitComponentImporter$7 = () => import("./products-BoXfvUXp.mjs");
...
const $$splitComponentImporter$5 = () => import("./enquiry-DWpI276k.mjs");
...
const $$splitComponentImporter$3 = () => import("./checkout-BVhAqag9.mjs");
const Route$3 = createFileRoute("/checkout")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./about-TbgGo9SK.mjs");
...
const $$splitComponentImporter$1 = () => import("./index-CnTHrJE_.mjs");
...
const $$splitComponentImporter = () => import("./products_._productId-B8nyepDd.mjs");
